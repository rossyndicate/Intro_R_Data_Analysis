...
Install software here: [**https://posit.co/download/rstudio-desktop/**](https://posit.co/download/rstudio-desktop/){.uri}

1.  First Install R. Follow the link and choose the correct download based on your operating system (Mac, Windows, Linux)
2.  Then, **after installing R**, click the second link to install RStudio.

*Note: If you already have R installed, you **must have at least version 4.4.0. or greater**, but it is best to have the most recent version installed (4.5.2)*
