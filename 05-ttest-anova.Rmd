...
Now load in the three libraries/packages needed for this lesson (OR, add `lterdatasampler` and `rstatix`` to your 'setup.R' script if you have been setting up your environment that way).
