...
p_aqi_preview <- fc_summer %>%
  ...
  geom_text(data = smoke_2026,
            x = as.Date("2026-07-05"), 
            y = 99,
            label = "Aug 3–8 smoke episode:\nworst AQI of the summer",
            inherit.aes = FALSE, 
            size = 2.8, 
            hjust = 0, 
            vjust = 1,
...
Annotation is the process of adding text, lines, shading, or other notes to your charts. In our final figure we want to communicate two things about the air-quality series: where the Good/Moderate AQI boundary falls, and when the worst smoke episode of the summer occurred.
