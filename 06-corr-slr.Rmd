...
ggplot(icecover_temp) +
  geom_point(aes(x = mean_air_temp, y = mean_duration))
...
**5.** Plot the mean air temperature against the mean ice cover duration. Include our simple linear regression (i.e., the line of best fit) in the plot. (3 pts.)
